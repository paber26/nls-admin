<template>
  ...
  <body class="bg-slate-100 font-poppins min-h-screen flex items-center justify-center">
    <!-- ================= LOGIN CARD ================= -->
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 text-center">
      ...
      <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 mt-2">
          Masuk menggunakan akun Google untuk mulai tryout KSN SMA
        </p>
      </div>

      <!-- Google Button -->
      <a href="#"
        class="flex items-center justify-center gap-3 w-full border border-slate-300 rounded-lg py-3 hover:bg-slate-50 transition">
