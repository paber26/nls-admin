          ...
          <tbody>
            ...
            <tr v-for="(item, index) in tryouts" :key="item.id" class="border-t">
              ...
              <td class="px-4 py-3 text-center">
                ...
                <span v-if="item.requires_access_key" class="inline-block ml-2 text-purple-600" title="Terkunci">
                  <svg class="w-4 h-4 inline align-text-bottom" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
                </span>
              </td>
