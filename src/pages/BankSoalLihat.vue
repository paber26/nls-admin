  ...
  <div class="flex min-h-screen bg-bgsoft font-poppins">
    ...
    <main class="flex-1 px-6 py-6">
      ...
      <div class="bg-white border rounded-xl p-6 space-y-6 w-full">
        ...
        <div v-if="tipeSoal === 'pg_kompleks'">
          ...
          >
            ...
            <span
              ...
              :class="item.jawaban ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'"
            >
        ...
        <div class="pt-4">
          <button @click="router.push('/banksoal')" class="px-4 py-2 rounded-lg bg-gray-200 text-sm hover:bg-gray-300">
            Kembali
          </button>
        </div>
      </div>
