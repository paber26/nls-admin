  ...
  <div class="flex min-h-screen bg-bgsoft font-poppins">
    ...
    <main class="flex-1 px-6 py-6 space-y-6">
      ...
      <section class="bg-white rounded-xl border p-6">
        <h2 class="font-medium mb-4">Soal dalam Tryout</h2>

        <div v-if="loadingSoal" class="text-sm text-slate-400">Memuat soal...</div>
      ...
      <section class="bg-white rounded-xl border p-6">
        ...
        <h2 class="font-medium mb-4">Tambah Soal dari Bank Soal</h2>
