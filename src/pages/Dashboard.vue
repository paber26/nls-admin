                ...
                <div class="px-6 py-8">
                    ...
                    <section class="grid md:grid-cols-4 gap-6 mb-10">
                        ...
                        <div class="bg-white p-6 rounded-xl border flex items-center gap-5">
                            <div
                                class="w-12 h-12 rounded-lg bg-indigo-100 flex items-center justify-center text-indigo-600 text-xl">
                                🏫
                            </div>
                            <div>
                    ...
                    <section>
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            <div class="bg-white p-6 rounded-xl border">
                                ...
                                <h4 class="font-medium mt-3 text-slate-800">
                                    Tryout OSN Matematika
                                </h4>
